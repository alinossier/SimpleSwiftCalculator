...
class ViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.view.addSubview(CurrentCalcLabel)
        
        // Insert the label that will show the results
        ResultLabel.frame = CGRect(x: 0, y: CurrentCalcLabelY - 200, width: screenSize.width, height: ButtonHeight)
        ResultLabel.textColor = UIColor.black
        ResultLabel.font = ResultLabel.font.withSize(75)
    ...
    func ProcessString(){
        ...
        ResultLabel.text = forTailingZero(temp: Result)
